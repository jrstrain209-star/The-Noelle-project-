    ...
    <main className="min-h-screen bg-[#050716] text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#050716]/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          ...
          <a href="#help" className="rounded-full bg-pink-200 px-6 py-2 text-sm font-semibold text-slate-950">
            Get Help Now
          </a>
        </div>
      </header>
      ...
      <section className="mx-auto max-w-6xl px-5 py-20 text-center sm:py-28">
        ...
        <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
          <a href="#share" className="rounded-full bg-white px-8 py-3 text-sm font-semibold text-slate-950">
            Share Your Story
          </a>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-8 backdrop-blur-sm">
          ...
          <p className="mt-4 leading-7 text-white/80">
            A memorial project and peer-support community for people struggling with grief, loneliness,
            mental health, addiction, trauma, and loss.
          </p>
        </div>
      </section>
...
<CommunitySection />
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="rounded-3xl border border-purple-300/20 bg-purple-300/5 p-8 backdrop-blur-sm">
          ...
          <a href="/memorial" className="inline-block rounded-full bg-purple-400 px-8 py-3 text-sm font-semibold text-slate-950">
            Visit Memorial Wall
          </a>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {futureIdeas.map((idea) => (
            <div key={idea} className="rounded-xl border border-white/10 bg-white/[0.06] p-5 text-white/80">
              {idea}
            </div>
          ))}
        </div>
